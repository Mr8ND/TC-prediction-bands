...
#' numeric. If latitude ends in "S", drop "S" and convert latitude to negative 
#' numeric.
#'
...
#' 
#' @description If longitude ends in "E", drop "E" and convert longitude to 
#' numeric. If longitude ends in "W", drop "W" and convert longitude to negative
#' numeric.
#'
...
pull_data <- function() {
  ...
  cols <- c("date", "time", "record_id", "status", "lat", "long", 
            "max_sust_wind", "min_pressure", "wind_NE_34", "wind_SE_34", 
            "wind_SW_34", "wind_NW_34", "wind_NE_50", "wind_SE_50", 
            "wind_SW_50", "wind_NW_50", "wind_NE_64", "wind_SE_64", 
            "wind_SW_64", "wind_NW_64")
